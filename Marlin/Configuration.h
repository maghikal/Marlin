 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 401.7 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 250, 25, 25 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, 0, -2.175 }
...
#define X_BED_SIZE 218  //Hemera nozzle is shifted over from stock position making bed smaller from original 235 mm
#define Y_BED_SIZE 226  //Hemera nozzle is shifted over from stock position making bed smaller from original 235 mm
